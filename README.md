...
| Category       | Badges |
|----------------|--------|
| **Build**      | [![CI](https://github.com/CCPBioSim/Python-Template/actions/workflows/NMR_MD_project-ci.yaml/badge.svg)](https://github.com/CCPBioSim/Python-Template/actions/workflows/NMR_MD_project-ci.yaml) |
